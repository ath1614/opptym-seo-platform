...
export default function TechnicalSeoAuditorPage() {
  ...
  const handleExport = () => {
    ...
    a.href = url
    a.download = 'technical-seo-analysis.csv'
    a.click()
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center space-x-2">
              ...
              <span>Technical SEO Auditor Analysis</span>
            </CardTitle>
            <CardDescription>
              Select a project to analyze technical-seo for SEO optimization
            </CardDescription>
          </CardHeader>
          <CardContent>
              ...
              >
                {isAnalyzing ? (
                  <>
                    ...
                    Analyzing Technical SEO Auditor...
                  </>
                ) : (
                  <>
                    <Search className="h-4 w-4 mr-2" />
                    Analyze Technical SEO Auditor
                  </>
                )}
              </Button>
            </div>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center justify-between">
                  <span>Technical SEO Auditor Analysis Results</span>
                  <div className="flex items-center space-x-2">
