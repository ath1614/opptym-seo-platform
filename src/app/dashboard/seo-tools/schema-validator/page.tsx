...
export default function SchemaValidatorPage() {
  ...
  const getSchemaTypeColor = (type: string) => {
    switch (type) {
      case 'Organization': return 'bg-blue-100 text-blue-800 dark:bg-blue-900/20 dark:text-blue-400'
      case 'WebSite': return 'bg-green-100 text-green-800 dark:bg-green-900/20 dark:text-green-400'
      case 'Article': return 'bg-purple-100 text-purple-800 dark:bg-purple-900/20 dark:text-purple-400'
      case 'Product': return 'bg-orange-100 text-orange-800 dark:bg-orange-900/20 dark:text-orange-400'
      default: return 'bg-gray-100 text-gray-800 dark:bg-gray-900/20 dark:text-gray-400'
    }
  }
