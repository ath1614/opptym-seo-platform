        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center space-x-2">
              ...
              <span>Keyword Researcher Analysis</span>
            </CardTitle>
            <CardDescription>
              Select a project to analyze keyword-research for SEO optimization
            </CardDescription>
          </CardHeader>
          <CardContent>
              ...
              >
                {isAnalyzing ? (
                  <>
                    ...
                    Analyzing Keyword Researcher...
                  </>
                ) : (
                  <>
                    <Search className="h-4 w-4 mr-2" />
                    Analyze Keyword Researcher
                  </>
                )}
              </Button>
            </div>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center justify-between">
                  <span>Keyword Researcher Analysis Results</span>
                  <div className="flex items-center space-x-2">
