    ...
    try {
      ...
      if (response.ok) {
        ...
        showToast({
          ...
          description: data.error || 'Failed to analyze sitemap-robots',
          variant: 'destructive'
        })
      }
    } catch (error) {
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center space-x-2">
              ...
              <span>Sitemap & Robots Checker Analysis</span>
            </CardTitle>
            <CardDescription>
              Select a project to analyze sitemap-robots for SEO optimization
            </CardDescription>
          </CardHeader>
          <CardContent>
              ...
              >
                {isAnalyzing ? (
                  <>
                    ...
                    Analyzing Sitemap & Robots Checker...
                  </>
                ) : (
                  <>
                    <Search className="h-4 w-4 mr-2" />
                    Analyze Sitemap & Robots Checker
                  </>
                )}
              </Button>
            </div>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center justify-between">
                  <span>Sitemap & Robots Checker Analysis Results</span>
                  <div className="flex items-center space-x-2">
